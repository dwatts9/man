...
//  Blog Reader
//
//  Created by Damien Watts on 07/26/16
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyASCcMlK7l7IyVylnoGcYGIjzeTcT0zGEU")!
    ...
    var fetchedResultsController: NSFetchedResultsController<Event> {
        ...
        let sortDescriptor = SortDescriptor(key: "published", ascending: false)
